...
module.exports = function (grunt) {
  grunt.initConfig({
    ...
    sass: {
      min: {
        files: {
          'dist/react-datecounter.css': 'src/stylesheets/datecounter.scss',
          'dist/react-datecounter-cssmodules.css': 'src/stylesheets/datecounter-cssmodules.scss'
        },
        options: {
          sourcemap: 'none',
          style: 'expanded'
      ...
      unmin: {
        files: {
          'dist/react-datecounter.min.css': 'src/stylesheets/datecounter.scss',
          'dist/react-datecounter-cssmodules.min.css': 'src/stylesheets/datecounter-cssmodules.scss'
        },
        options: {
          sourcemap: 'none',
          style: 'compressed'
    ...
    webpack: {
      unmin: mergeWebpackConfig({
        output: {
          filename: 'react-datecounter.js'
        }
      }),
      min: mergeWebpackConfig({
        output: {
          filename: 'react-datecounter.min.js'
        },
        plugins: [
